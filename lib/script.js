...
/* =========================================================================
 ...
 ========================================================================= */
const manzana = { id: 1, nombre: "manzana", categoria: "fruta", precio: 20.5, stock: 8, icono:
"images/manzana.jpg" };
const pina = { id: 2, nombre: "pina", categoria: "fruta", precio: 15.35, stock: 5, icono: "images/pina.jpg" };
const pera = { id: 3, nombre: "pera", categoria: "fruta", precio: 5.45, stock: 12, icono: "images/pera.jpg" };const melon = { id: 4, nombre: "melon", categoria: "fruta", precio: 6.15, stock: 3, icono: "images/melon.jpg" };
const zanahoria = { id: 5, nombre: "zanahoria", categoria: "verdura", precio: 3.2, stock: 14, icono:
"images/zanahoria.jpg" };
const tomate = { id: 6, nombre: "tomate", categoria: "verdura", precio: 4.75, stock: 0, icono:
"images/tomate.jpg" };
const jugo = { id: 7, nombre: "jugo", categoria: "bebida", precio: 12.0, stock: 6, icono: "images/jugo.jpg" };
const cocoAgua = { id: 8, nombre: "aguaCoco", categoria: "bebida", precio: 8.9, stock: 4, icono:
"images/aguaCoco.jpg" };
...
const renderizarCarrito = function () {
 ...
 <img src="images/${item.nombre}.jpg" style="width: 20%; height: 100%;"> ${item.nombre}</p> <p class="detalle-linea">${item.cantidad} × ${formatearPrecio(item.precio)} = ${formatearPrecio(item.precio * item.cantidad)}</p>
 `;
